...
- prop-types : outil de validation de type, permet de contrôler le type de données que les composants se transmettent afin d'assurer le respect de leur intégrité.

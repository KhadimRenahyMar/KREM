            ...
            <ul className="reviewScreen__list">
                <li className="reviewScreen__review">
                    ...
                    <p className="reviewScreen__review-text">
                        ...
                        <br /><br />
                        Les notions essentielles sont acquises tant au niveau du front que du back. C’est désormais la pratique et la rencontre de défis algorithmiques qui te tireront vers le haut. "C’est en forgeant que l’on devient forgeron". Multiplie les petits projets, ou poursuit tes apprentissages sur de plus gros, en parallèle de tes recherches d’emploi. "Null" doute que tu continueras de progresser !
                        <br /><br />

                        ...
                        <table className="table">
                            ...
                            <tbody className="table-body">
                                ...
                                <tr className="table-row">
                                    ...
                                    <td className="table-data table-data--value">Test de requête</td>
                                </tr>
                                <tr className="table-row">
                    ...
                    <div className="skillScreen__skill-contentBx hidden">
                        ...
                        <table className="table">
                            ...
                            <tbody className="table-body">
                                ...
                                <tr className="table-row">
                                    <td className="table-subhead">Gestion des Régionalité</td>
                                </tr>
                                <tr className="table-row">
                                ...
                                <tr className="table-row">
                                    <td className="table-data">Gestion origines multiples</td>
                                </tr>
                                <tr className="table-row">
                                            ...
                                            <li key={tech.name} className="skillScreen__tech">
                                                <div className="skillScreen__tech-titleBx" onClick={showMore}>
                                                    <div className="skillScreen__tech-title">
                                                        <div className="skillScreen__tech-layer" style={{ width: `${tech.percent}%`, backgroundColor: '#FFAA00' }}></div>
                                                        <img src={`/techLogos/${tech.name}.png`} alt="" className="skillScreen__tech-icon" />
                                                ...
                                                <div className="skillScreen__techBx hidden">
                                                    ...
                                                    <table className="table" >
                                                        ...
                                                        </thead>
                                                        {
                                                            ...
                                                            <p className="skillScreen__tech-message">Désolé, aucun package n'a été trouvé pour cette technologie. Essayer un autre onglet !</p>
                                                        )
                                                    }
                                                </div>
                                            </li>

...
export default function Header() {
    ...
    const toggle = (e) => {
        const modal = e.currentTarget.parentElement.childNodes[2];
    ...
    return isMobile() ? (
        ...
        <header className='header'>
            <div className="header__nav">
                <div className="header__logo">
                    <svg className='header__logo-icon' xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="249.577" height="286.098" viewBox="0 0 249.577 286.098">
                        <defs>
                            <filter id="Tracé_178" x="0" y="0" width="249.577" height="286.098" filterUnits="userSpaceOnUse">
                                <feOffset input="SourceAlpha" />
                                <feGaussianBlur stdDeviation="2" result="blur" />
                                <feFlood />
                                <feComposite operator="in" in2="blur" />

                ...
                isMobile ? (
                    ...
                    >
                        <SplideTrack className='splide__track'>
                            {
                                techs.map((tech) => (
                                    <SplideSlide key={tech.name} className="slide" onClick={(e) => sortProjects(e, tech.filename)}>
                                        ...
                                        <img src={tech.logo.secure_url} alt={`logo ${tech.logo.filename}`} className="slide__techLogo" />
                                    </SplideSlide>
                                ))
                            }
                        </SplideTrack>

                ...
                <div className="landingPage__contentBx">
                    ...
                    <div className='landingPage__hive'>
                        ...
                        <svg className="landingPage__hive--shape" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="281.33" height="310.113" viewBox="0 0 281.33 310.113">
                            ...
                            <path id="Tracé_420-2" data-name="Tracé 420" d="M245.86,71.519l.2,141.069L123.734,283.3,1.208,212.939,1,71.87,123.326,1.16Z" transform="translate(22.27 13.43)" fill="#04192e" stroke="#fff" strokeMiterlimit="10" strokeWidth="5" />
                            <path id="Tracé_419-2" data-name="Tracé 419" d="M245.86,71.519l.2,141.069L123.734,283.3,1.208,212.939,1,71.87,123.326,1.16Z" transform="translate(7.5 7.73)" fill="#04192e" stroke="#fa0" strokeMiterlimit="10" strokeWidth="5" />
                        </svg>
                    </div>
                </div>
                <span className='landingPage__icon' onClick={scroll}>
